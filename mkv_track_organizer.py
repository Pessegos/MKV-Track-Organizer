...
LANGUAGE_VARIANT_HINTS = {
    ...
    "chi": (
        ("zh-TW", ("zh-tw", "taiwan", "taiwanese", "taiwanese mandarin")),
...
LANGUAGE_NAME_HINTS = (
    ...
    ("zh-TW", ("zh-tw", "chinese taiwan", "taiwan chinese", "taiwanese chinese", "taiwanese mandarin", "taiwan")),
...
def track_is_english_first_audio(track: TrackInfo) -> bool:
    return any(track_matches_language_code(track, language_code) for language_code in ENGLISH_FIRST_AUDIO_CODES)
